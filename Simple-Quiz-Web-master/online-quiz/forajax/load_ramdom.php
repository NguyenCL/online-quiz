...
$res = mysqli_query($link, "SELECT * FROM questions WHERE id = $_GET[id]");
$count = mysqli_num_rows($res);
*/
/*$res=mysqli_query($link,"select * from questions where category='$_SESSION[exam_category]' 
&& question_no=$_GET[questionno]");*/
$res = mysqli_query($link, "SELECT * FROM questions ORDER BY RAND() LIMIT 20");
$count=mysqli_num_rows($res);
...
<head>
    ...
    <link rel="stylesheet" href="\Simple-Quiz-Web-master\Simple-Quiz-Web-master\online-quiz\css\question.css">
