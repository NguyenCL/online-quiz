...
$res=mysqli_query($link,"select r.username, c.describe, r.total_question, r.correct_answer, r.wrong_answer, r.exam_time from exam_results r join exam_category c on r.exam_type = c.id where username='$_SESSION[username]' order by r.id desc");
