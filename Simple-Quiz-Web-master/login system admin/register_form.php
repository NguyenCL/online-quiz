...
if (isset($_POST['submit'])) { // sử dụng hàm isset($_POST['submit']) kiểm tra xem biểu mẫu đã được gửi đi chưa
    ...
    if (mysqli_num_rows($result) > 0) { // kiểm tra số lượng bản ghi trong kết quả truy vấn 
        ...
        if ($pass != $cpass) { // kiểm tra mật khẩu và nhập lại mật khẩu có trùng nhau
            ...
            $insert = "INSERT INTO registration(firstname, lastname, username, password,email,contact,birthday,phonenum,role) VALUES('$firstname','$lastname','$name','$pass','$email','$contact','$birthday','$phone_number','$role')";
    ...
    <div class="form-container">
        ...
        <form action="" method="post">
            ...
            <div class="input-icon-login">
                <input type="text" name="lastname" placeholder="Nhập vào họ giáo viên">
                <i class="fas fa-user"></i>

                <div class="input-icon-login">
                    <input type="text" name="firstname" required placeholder="Nhập vào tên giáo viên">
                    <i class="fas fa-user"></i>
                </div>
            ...
            <div class="input-icon-login">
                <input type="text" name="username" placeholder="Nhập vào tên đăng nhập">
                <i class="fas fa-user"></i>
            </div>
